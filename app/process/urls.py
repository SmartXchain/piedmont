...
urlpatterns = [
    ...
    path('<int:process_id>/steps/', views.process_steps_view, name='process_steps'),
    path('<int:process_id>/edit/', views.process_edit_view, name='process_edit'),
    path('<int:process_id>/steps_list/', views.process_step_list_view, name='process_step_list'),
