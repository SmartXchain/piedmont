...
urlpatterns = [
    ...
    path('<int:job_id>/process-steps/', views.job_process_steps_view, name='job_process_steps'),
    path('<int:detail_id>/process-steps/', views.part_process_steps_view, name='part_process_steps'),
]
